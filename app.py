...
def main():
    ...
    no_of_children = st.slider("Number of Children", min_value=0, max_value=10.0, value=1)
    no_of_weekend_nights = st.slider("Number of Weekend Nights", min_value=0, max_value=7, value=1)
    no_of_week_nights = st.slider("Number of Week Nights", min_value=0, max_value=17.0, value=1)
    ...
    lead_time = st.slider("Lead Time", min_value=0, max_value=443.0, value=1)
    ...
    no_of_previous_bookings_not_canceled = st.slider("Number of Previous Bookings Not Canceled", min_value=0, max_value=58.0, value=1)
    avg_price_per_room = st.slider("Average Price Per Room", min_value=0, max_value=540.0, value=1)
